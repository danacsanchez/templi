...
const ExtensionForm = ({ extension, onSave, onCancel, isOpen }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await onSave({ ...formData, nombre: formData.nombre.trim() });
    } catch (error) {
    ...
    <div style={overlayStyle}>
      <div style={modalStyle}>
        <div style={headerStyle}>
          <h2 style={titleStyle}>
            {extension ? 'Editar Extensión' : 'Añadir Extensión'}
          </h2>
        ...
        <form onSubmit={handleSubmit} style={formStyle}>
          <div style={fieldContainerStyle}>
            ...
            <input
              ...
              placeholder="Ingresa el nombre de la extensión"
          ...
          <div style={buttonContainerStyle}>
            ...
            <button
              type="submit"
              style={{ ...saveButtonStyle, ...(isSubmitting ? disabledButtonStyle : {}) }}
              disabled={isSubmitting}
            >
              {isSubmitting ? (
                <>
                  <span className="material-symbols-outlined" style={loadingIconStyle}>refresh</span>
                  {extension ? 'Actualizando...' : 'Guardando...'}
                </>
              ) : (
                <>
